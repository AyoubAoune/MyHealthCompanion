    ...
    return (
      <div className="min-h-screen bg-background text-foreground p-4 md:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Column 1 Skeletons - now with 2x2 layout on md */}
          <section className="lg:col-span-2 space-y-6">
            {/* Row 1 Skeletons */}
            <div className="md:flex md:gap-6">
              <Skeleton className="h-64 w-full md:flex-1 rounded-lg mb-6 md:mb-0" /> {/* IntakeProgressCard Skeleton */}
              <Skeleton className="h-72 w-full md:flex-1 rounded-lg" />             {/* DailyChecklistCard Skeleton */}
            </div>
            {/* Row 2 Skeletons */}
            <div className="md:flex md:gap-6">
              <Skeleton className="h-60 w-full md:flex-1 rounded-lg mb-6 md:mb-0" /> {/* RewardsCard Skeleton */}
              <Skeleton className="h-56 w-full md:flex-1 rounded-lg" />             {/* HelpfulTopicsCard Skeleton */}
            </div>
          </section>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-4 md:p-8">
      ...
      <main className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <section className="lg:col-span-2 space-y-6">
          <div className="md:flex md:gap-6">
            <div className="md:flex-1 w-full mb-6 md:mb-0">
              <IntakeProgressCard />
            </div>
